...
class ClueAI():
    def __init__(self):
        ...
        self.tokenizer = T5Tokenizer.from_pretrained("/home/albay/djs/app/clueAI")
        self.model = T5ForConditionalGeneration.from_pretrained("/home/albay/djs/app/clueAI").to(self.device)   
